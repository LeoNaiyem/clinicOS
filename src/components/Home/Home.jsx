        ...
        <div className="col-lg-3 col-md-6">
          <div className="ibox bg-success color-white widget-stat">
            <div className="ibox-body">
              ...
              <i className="ti-shopping-cart widget-stat-icon"></i>
              <div>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="ibox bg-info color-white widget-stat">
            <div className="ibox-body">
              ...
              <div className="m-b-5">UNIQUE VIEWS</div>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="ibox bg-warning color-white widget-stat">
            <div className="ibox-body">
              ...
              <div className="m-b-5">TOTAL INCOME</div>
        ...
        <div className="col-lg-3 col-md-6">
          <div className="ibox bg-danger color-white widget-stat">
            <div className="ibox-body">
              ...
              <div className="m-b-5">NEW USERS</div>
              <i className="ti-user widget-stat-icon"></i>
              <div>
                <i className="fa fa-level-down m-r-5"></i>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <span className="text-success ml-2">
                        <i className="fa fa-level-up"></i> +25%
                      </span>
                    </div>
                  </div>
                  <div className="px-3">
                    ...
                    <div>
                      ...
                      <span className="text-warning ml-2">
                        <i className="fa fa-level-down"></i> -12%
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-6">
                  <div className="m-b-20 text-success">
                    <i className="fa fa-circle-o m-r-10"></i>Desktop 52%
                  </div>
                  <div className="m-b-20 text-info">
                    <i className="fa fa-circle-o m-r-10"></i>Tablet 27%
                  </div>
                  <div className="m-b-20 text-warning">
                    <i className="fa fa-circle-o m-r-10"></i>Mobile 21%
                  </div>
                </div>
              </div>
              <ul className="list-group list-group-divider list-group-full">
                <li className="list-group-item">
                  ...
                  <span className="float-right text-success">
                    <i className="fa fa-caret-up"></i> 24%
                  </span>
                </li>
                <li className="list-group-item">
                  Firefox
                  <span className="float-right text-success">
                    <i className="fa fa-caret-up"></i> 12%
                  </span>
                </li>
                <li className="list-group-item">
                  Opera
                  <span className="float-right text-danger">
                    <i className="fa fa-caret-down"></i> 4%
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="ibox-body">
              ...
              <table className="table table-striped m-t-20 visitors-table">
                ...
                <tbody>
                  <tr>
                    <td>
                      <img className="m-r-10" src="./assets/img/flags/us.png" />
                      USA
                    </td>
                    <td>755</td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <img
                        className="m-r-10"
                        src="./assets/img/flags/India.png"
                      />
                      India
                    </td>
                    <td>410</td>
                  ...
                  <tr>
                    <td>
                      <img
                        className="m-r-10"
                        src="./assets/img/flags/Singapore.png"
                      />
                      Singapore
                    </td>
                    <td>203</td>
                  ...
                  <tr>
                    <td>
                      <img className="m-r-10" src="./assets/img/flags/uk.png" />
                      UK
                    </td>
                    <td>202</td>
                    <td>
              ...
              <ul className="list-group list-group-divider list-group-full tasks-list">
                <li className="list-group-item task-item">
                  ...
                  <div className="task-data">
                    <small className="text-muted">10 July 2018</small>
                  </div>
                  <div className="task-actions">
                    <a href="javascript:;">
                      <i className="fa fa-edit text-muted m-r-10"></i>
                    </a>
                    <a href="javascript:;">
                ...
                <li className="list-group-item task-item">
                  ...
                  <div className="task-data">
                    <small className="text-muted">22 May 2018</small>
                  </div>
                  <div className="task-actions">
                    <a href="javascript:;">
                      <i className="fa fa-edit text-muted m-r-10"></i>
                ...
                <li className="list-group-item task-item">
                  <div>
                    ...
                    <span className="badge badge-danger m-l-5">
                      <i className="ti-alarm-clock"></i> 1 hrs
                    </span>
                  </div>
                  <div className="task-data">
                ...
                <li className="list-group-item task-item">
                  ...
                  <div className="task-data">
                    <small className="text-muted">04 Apr 2018</small>
                  </div>
                  <div className="task-actions">
                    <a href="javascript:;">
                      <i className="fa fa-edit text-muted m-r-10"></i>
                ...
                <li className="list-group-item task-item">
                  ...
                  <div className="task-data">
                    <small className="text-muted">07 Dec 2018</small>
                  </div>
                  <div className="task-actions">
                    <a href="javascript:;">
                      <i className="fa fa-edit text-muted m-r-10"></i>
                ...
                <li className="media">
                  ...
                  <div className="media-body">
                    <div className="media-heading">
                      Jeanne Gonzalez
                      <small className="float-right text-muted">12:05</small>
                    </div>
            ...
            <div className="wrap-2">
              ...
              <div className="color-white" style={{ marginLeft: "40px" }}>
                ...
                <ul className="list-unstyled">
                  ...
                  <li className="m-b-5">
                    <i className="ti-check m-r-5"></i>Bootstrap 4 and Angular 5+
                  </li>
                  <li className="m-b-5">
